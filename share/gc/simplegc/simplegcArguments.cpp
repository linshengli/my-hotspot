...
void SimpleGCArguments::initialize() {
  ...
  // if (SimpleGCMaxTLABSize < MinTLABSize) {
  //   log_warning(gc)("SimpleGCMaxTLABSize < MinTLABSize, adjusting it to " SIZE_FORMAT, MinTLABSize);
  //   SimpleGCMaxTLABSize = MinTLABSize;
  // }

  // if (!SimpleGCElasticTLAB && SimpleGCElasticTLABDecay) {
  //   log_warning(gc)("Disabling SimpleGCElasticTLABDecay because SimpleGCElasticTLAB is disabled");
  //   FLAG_SET_DEFAULT(SimpleGCElasticTLABDecay, false);
  // }
